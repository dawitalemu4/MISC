...
Description: A plugin for managing inquiries with frontend form and backend data management. For the shortcode to display the form, use [custom-inquiry-form].
Version: 1.0
Author: Dawit Alemu
*/
