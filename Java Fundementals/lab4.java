...
public class lab4 {
    public static void main(String[] args) {
        ...
        while (radius != 0) {
            ...
            System.out.println("Enter circumference: " + circum);
        ...
        while (temp != 999) {
            if (temp > 32) {
                System.out.println("Temp is above freezing point ");
        ...
        int grade = 0, a = 0, b = 0, c = 0, d = 0, f = 0;
        avg = 0;
        ...
        System.out.println("You took " + track + " attempts to reach 100.");
    }
}
